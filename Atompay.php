...
class Atompay {
    ...
    public function setCustomerComments($customerComments) {
        $this->customerComments = $customercmments;
    }


    // public function getCustomerIntentionFor() {
    //     return $this->customerIntentionFor;
    // }

    // /**
    //  * @param string $customerName
    //  */
    // public function setCustomerIntentionFor($customerIntentionFor) {
    //     $this->customerIntentionFor = $customerIntentionFor;
    // }
    ...
    private function getData() {
        ...
        $strReqst .= "&udf4=" . $this->getCustomerComments();
         // $strReqst .= "&udf5=" .$this->getCustomerIntentionFor();
    ...
    public function atomRequest($env, $login, $password, $product, $amount, $currency, $returnUrl, $clientCode, $name, $email, $mobile, $comments, $account, $requestHashKey){
       ...
       $this->setCustomerComments($comments);
        // $this->setCustomerIntentionFor($intentionfor);
